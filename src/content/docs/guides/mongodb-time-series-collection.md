...
keywords: [time-series, mongodb, bucket, performance, design]
meta:
...
![ตัวอย่างข้อมูลสภาพอากาศแบบ time-series](../../../assets/guides/mongodb-time-series-collection/weather-data.webp)
...
![ตัวอย่างกราฟผู้ติดตามรายเดือนใน Influencer Directory](../../../assets/guides/mongodb-time-series-collection/influencer-directory-follower-example.webp)
...
![ตัวอย่างการจัดเก็บข้อมูลหลายช่วงเวลาใน bucket เดียว](../../../assets/guides/mongodb-time-series-collection/bucket-example.webp)
...
![ตัวอย่างการตั้งค่า granularity สำหรับ time-series collection](../../../assets/guides/mongodb-time-series-collection/granularity.webp)
...
![ตัวอย่างผลลัพธ์การบีบอัดข้อมูลใน bucket](../../../assets/guides/mongodb-time-series-collection/compressed.webp)
...
![ตัวอย่างเปรียบเทียบข้อมูลก่อนและหลังการบีบอัด](../../../assets/guides/mongodb-time-series-collection/compressed-2.webp)
